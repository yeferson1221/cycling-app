...
export function Login(){
    ...
    <div className="w-full max-w-xs m-auto">
        ...
        <button className="bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Login</button>  
    </form>
    <button className="bg-slate-50 hover:bg-slate-200 text-black font-bold py-2 px-4 shadow-md rounded  border-gray-300 py-2 px-4 w-full" onClick={handleGoogleSignin} >Login with Google</button>
    </div>
    )
}